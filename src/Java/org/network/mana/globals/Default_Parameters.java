...
public class Default_Parameters {
    ...
    */
    ...
    public static final double init_v_m = -49;
    ...
    public static final double default_lowFR = 1.5;
    public static final double default_beta = 9;
    ...
    public static final double DEF_NEW_WEIGHT = 0.00001;
